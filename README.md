...
```text
       ...
       SW1                   SW2
        │                     │
        ▼                     ▼
   Rate Selection        Colour Selection
        │                     │
        ▼                     ▼
  1000 → 500 → 250      R → G → B → W
        │                     │
        └──────────┬──────────┘
                   │
                   ▼
...
| Feature | Program 1 | Program 2 |
|---|---|---|
| SW1 | Colour selection | Rate selection |
| SW2 | Colour selection | Colour selection |
| RGB LED | Yes | Yes |
| Multiple switch combinations | Yes | — |
| Cyclic rate | — | Yes |
| Cyclic colour | — | Yes |
| Edge detection | — | Yes |
| Software delay | — | Yes |
